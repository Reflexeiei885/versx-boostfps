...
export default function WindowsTweaksTab() {
  ...
  const handleCleanup = () => {
    setIsCleaning(true);
    addLog("INFO", "Scanning temporary files...");
    let total = 0;
    ...
    const interval = setInterval(() => {
      ...
      if (total >= 847) {
        ...
        setIsCleaning(false);
        addLog("SUCCESS", `Cleaned ${(total / 1024).toFixed(2)} GB of temporary files.`);
        addToast({
          type: "success",
          title: "Cleanup Complete",
          message: `${total} MB freed from temp & cache.`
        });
      }
    }, 100);
  };
      ...
      <div className="grid gap-3">
        ...
        <ToggleSwitch
          ...
          onToggle={(val) => {
            ...
            addToast({
              type: val ? "success" : "info",
              title: `Visual Effects ${val ? "Disabled" : "Enabled"}`
            });
          }}
        />
        <ToggleSwitch
          ...
          onToggle={(val) => {
            ...
            addToast({
              type: val ? "success" : "info",
              title: `Startup ${val ? "Optimized" : "Reverted"}`
            });
          }}
        />
      </div>
